...
export const apiSlice = createApi({
    ...
    tagTypes: ['Product', 'Dashboard', "Category", "Faq", "User", "PrivacyPolicy", "TermsCondition", "AboutUs", "Profile", "Orders", "Stats", "Categories", "Caterings", "Notification", "Job", "Promo", "Qr", "CateringBooking"],
    endpoints: () => ({}),
});